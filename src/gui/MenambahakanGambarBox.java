...
public class MenambahakanGambarBox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/51Igy3jgquL._AC_SY1000_.jpg"))); // NOI18N
        pCardLayout.add(jLabel2, "0");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/b0-3 (1).jpg"))); // NOI18N
        pCardLayout.add(jLabel3, "1");

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/8133fU+X-QL._CR0,232,1201,1201_UX256.jpg"))); // NOI18N
        ...
        pilihanpilihCard.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Persona 1", "Persona 2", "Persona 3" }));
